...
interface ConversationDAO {
    ...
    @Query("SELECT id FROM conversationentity WHERE assistant_id = :assistantId ORDER BY create_at ASC, id ASC")
    suspend fun getAllIdsOfAssistant(assistantId: String): List<String>
